...
hl.bind("ALT + F4",
    ...
    { non_consuming = true })
hl.bind("SUPER + C", hl.dsp.window.close(), { description = "Window: Close" }) -- Close
hl.bind("SUPER + SHIFT + ALT + Q", hl.dsp.exec_cmd("hyprctl kill"), { description = "Window: Forcefully zap a window" })

--# Cycle through workspaces with Alt + Tab
--hl.bind("ALT + Tab" exec, ~/.config/hypr/scripts/cycle-workspaces.sh)
...
hl.bind("code:49", hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_SOURCE@ toggle"),
